---
id: RENDER-07
title: "[WGPUI 2.0] RENDER-07: Shadow and underline shader cleanup"
state: open
labels: wgpui-2.0,render
---
## Scope

crates/wgpui-wgpu/src/render/shaders

## Required outcome

Remove stale placeholder claims, verify shader paths, and add visual regression coverage.
