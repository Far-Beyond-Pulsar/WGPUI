---
id: INPUT-02
title: "[WGPUI 2.0] INPUT-02: Typed action dispatch"
state: open
labels: wgpui-2.0,input
---
## Scope

crates/wgpui-core/src/action; crates/wgpui-core/src/window

## Required outcome

Test typed action registration, propagation, handled state, and public dispatch APIs.
