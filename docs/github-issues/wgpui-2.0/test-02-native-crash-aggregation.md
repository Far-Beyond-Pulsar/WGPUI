---
id: TEST-02
title: "[WGPUI 2.0] TEST-02: Native crash aggregation"
state: open
...
Add optional Windows native debugger attachment and aggregate Rust panic, validation, and process crash evidence.
