---
id: TEST-03
title: "[WGPUI 2.0] TEST-03: Screenshot golden suite"
state: open
labels: wgpui-2.0,test
---
## Scope

crates/wgpui-examples-2; tests

## Required outcome

Capture deterministic screenshots for representative examples and compare retained rendering regressions.
