---
id: WIDGET-03
title: "[WGPUI 2.0] WIDGET-03: Uniform list recycling"
state: open
labels: wgpui-2.0,widget
---
## Scope

crates/wgpui-widgets/src/list/uniform_list.rs

## Required outcome

Recycle retained list rows without state leakage, stale bindings, or unnecessary full-tree rebuilds.
