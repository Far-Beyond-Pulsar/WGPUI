---
id: LAYOUT-06
title: "[WGPUI 2.0] LAYOUT-06: Layout shader limits"
state: open
labels: wgpui-2.0,layout
---
## Scope

crates/wgpui-core/src/shaders/layout_uniform.wgsl; crates/wgpui-wgpu/src/render/device.rs

## Required outcome

Validate device limits before enabling layout compute and return explicit unsupported errors.
