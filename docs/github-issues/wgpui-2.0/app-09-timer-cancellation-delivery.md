---
id: APP-09
title: "[WGPUI 2.0] APP-09: Timer cancellation delivery"
state: open
labels: wgpui-2.0,app
---
## Scope

crates/wgpui-core/src/window/timer.rs; crates/wgpui-wgpu/src/window/application.rs

## Required outcome

Guarantee cancelled timers cannot deliver callbacks and test cancellation during callback dispatch.
