---
id: APP-06
title: "[WGPUI 2.0] APP-06: Application window teardown notifications"
state: open
...
Remove closed windows from observer and invalidation routing without retaining callbacks or stale handles.
