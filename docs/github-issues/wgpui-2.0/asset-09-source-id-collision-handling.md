---
id: ASSET-09
title: "[WGPUI 2.0] ASSET-09: Source ID collision handling"
state: open
labels: wgpui-2.0,asset
---
## Scope

crates/wgpui-widgets/src/img.rs; crates/wgpui-wgpu/src/window/application.rs

## Required outcome

Make source identity collision-resistant and test distinct resources with equivalent display metadata.
