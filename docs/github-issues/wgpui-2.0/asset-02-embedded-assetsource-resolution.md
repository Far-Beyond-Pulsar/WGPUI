---
id: ASSET-02
title: "[WGPUI 2.0] ASSET-02: Embedded AssetSource resolution"
state: closed
labels: wgpui-2.0,asset
---
## Scope

crates/wgpui-widgets/src/assets.rs; crates/wgpui-widgets/src/img.rs; crates/wgpui-widgets/src/svg.rs

## Required outcome

Resolve embedded resources through the configured AssetSource without filesystem-only lookup.
...
Status: completed and verified in the current WGPUI 2.0 branch. Implementation commit: 61dfdcd796.
