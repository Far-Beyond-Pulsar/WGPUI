---
id: TEXT-05
title: "[WGPUI 2.0] TEXT-05: Text input shaping"
state: open
labels: wgpui-2.0,text
---
## Scope

crates/wgpui-widgets/src/text.rs; crates/wgpui-core/src/window

## Required outcome

Preserve cursor, selection, composition, and shaping state during text input updates.
