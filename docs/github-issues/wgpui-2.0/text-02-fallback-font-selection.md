---
id: TEXT-02
title: "[WGPUI 2.0] TEXT-02: Fallback font selection"
state: open
labels: wgpui-2.0,text
---
## Scope

crates/wgpui-text; crates/wgpui-widgets/src/styled_text.rs

## Required outcome

Select fallback fonts deterministically for missing glyphs and report unresolved glyphs visibly.
