---
id: RENDER-05
title: "[WGPUI 2.0] RENDER-05: Backdrop filter completeness"
state: open
labels: wgpui-2.0,render
---
## Scope

crates/wgpui-widgets/src/div; crates/wgpui-wgpu/src/render

## Required outcome

Complete backdrop filter lowering, capability checks, ordering, and explicit unsupported behavior.
