---
id: WINDOW-04
title: "[WGPUI 2.0] WINDOW-04: Interaction mutability boundary"
state: open
...
Expose interaction_mut() only at the public boundary and prevent core from depending on native window types.
