---
id: WINDOW-06
title: "[WGPUI 2.0] WINDOW-06: Surface resize and loss recovery"
state: open
labels: wgpui-2.0,window
---
## Scope

crates/wgpui-wgpu/src/render/device.rs; crates/wgpui-wgpu/src/window/application.rs

## Required outcome

Recover from resize, surface loss, and outdated surface errors without dropping retained scene state.
