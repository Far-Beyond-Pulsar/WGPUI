---
id: LAYOUT-07
title: "[WGPUI 2.0] LAYOUT-07: GPU layout pass fallback"
state: open
labels: wgpui-2.0,layout
---
## Scope

crates/wgpui-wgpu/src/render/compute/layout_pass.rs

## Required outcome

Select GPU layout only for supported workloads and preserve exact retained CPU fallback otherwise.
