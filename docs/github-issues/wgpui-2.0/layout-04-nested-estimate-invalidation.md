---
id: LAYOUT-04
title: "[WGPUI 2.0] LAYOUT-04: Nested estimate invalidation"
state: open
labels: wgpui-2.0,layout
---
## Scope

crates/wgpui-layout/src/containment.rs; crates/wgpui-widgets/src/div

## Required outcome

Invalidate only affected retained layout when a nested estimated size changes.
