...
fn radial_background_1() -> impl IntoElement {
    div().h_20().rounded_lg().bg(wgpui::radial_gradient(
        0.5,
        0.5,
        0.8,
        0.8,
        wgpui::gradient_color_stop(rgb(0xff5d73), 0.0),
        wgpui::gradient_color_stop(rgb(0x6d77ff), 1.0),
    ))
}
...
fn radial_background_2() -> impl IntoElement {
    div().h_20().rounded_lg().bg(wgpui::radial_gradient(
        ...
        0.9,
        0.6,
        wgpui::gradient_color_stop(rgb(0x80ed99), 0.0),
        wgpui::gradient_color_stop(rgb(0x000000), 1.0),
    ))
}
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .flex_col()
                    .gap_5()
            .child(div().text_lg().font_weight(wgpui::FontWeight::BOLD).child("Backdrop Blur Showcase"))
            .child(
                div()
                    .text_sm()
                    .text_color(rgb(0x999999))
