...
fn prepare_gradient_color(tag: u32, color_space: u32,
    ...
    if (tag == 0u || tag == 2u) {
        ...
        result.color0 = hsla_to_rgba(colors_0.color);
        result.color1 = hsla_to_rgba(colors_1.color);
...
fn gradient_color(background: Background, position: vec2<f32>, bounds: Bounds,
    ...
    switch (background.tag) {
        ...
        case 1u: {
            ...
            let stop0_percentage = background.colors_0.percentage;
            let stop1_percentage = background.colors_1.percentage;
