...
//!
//! `Pixels` and `Size` come from the native geometry module so buffering keeps
//! the same typed frontend contract as layout and retained rendering.

pub use crate::geometry::{Pixels, Size};
