...
$entries = @(
    @{ Name = "karaoke_text"; Path = "karaoke_text.rs" }, @{ Name = "karaoke_app"; Path = "karaoke_app.rs" }, @{ Name = "karaoke_multiline"; Path = "karaoke_multiline.rs" }, @{ Name = "text_gradients"; Path = "text_gradients.rs" },
